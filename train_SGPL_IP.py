...
def train(im_width, im_height, depth):
    ...
    for episode in range(EPISODE):
        ...
        # print("one_hot_labels_expanded",one_hot_labels.size())
        ...
        # torch.nn.utils.clip_grad_norm_(Prototype_network.parameters(), 0.5)
    ...
    torch.save(feature_encoder.state_dict(),str('./model/IP_feature_encoder_16way_1shot_newmodel_' + str(LEARNING_RATE2)+'_' + str(n_examples) + 'FT_' + str(EPISODE) + '.pkl'))
    torch.save(Prototype_network.state_dict(),str('./model/IP_network_16way_1shot_newmodel_' +str(LEARNING_RATE2)+'_' + str(n_examples) + 'FT_' + str(EPISODE) + '.pkl'))

...
def train(im_width, im_height, depth):
    ...
    for episode in range(EPISODE):
        ...
        one_hot_labels = one_hot_labels.view(20, 20, 1, 1)
    ...
    torch.save(feature_encoder.state_dict(),str('./model/3meta_training_feature_encoder_' +str(n_way) + 'way_' + str(n_shot) + 'shot_newmodel.pkl'))
    torch.save(Prototype_network.state_dict(),str('./model/3meta_training_network_' +str(n_way) + 'way_' + str(n_shot) + 'shot_newmodel.pkl'))
